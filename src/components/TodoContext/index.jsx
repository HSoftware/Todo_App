...
export function TodoProvider({ children }) {
  ...
  const searchedTodos = todos.filter((todo) => {
    // Retorna los todos que concuerdan con la búsqueda
  ...
  const completeTodo = (text) => {
    // Marca todo como completado y actualiza el estado. text es el identificador (key) del Todo
    const newTodos = [...todos]; // Crea una copia de los Todos
    const todoIndex = newTodos.findIndex(
      (
        todo, // Encuentra el indice del todo correspondiente
      ) => todo.text === text,
    );
  ...
  const deleteTodo = (text) => {
    // Borra un todo de la lista. text es el identificador
    const newTodos = [...todos]; // Crea una copia de los Todos
    const todoIndex = newTodos.findIndex(
      (
        todo, // Encuentra el indice del todo correspondiente
